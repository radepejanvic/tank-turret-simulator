...
const char* TextHandler::VERT_SHADER = "text.vert";
const char* TextHandler::FRAG_SHADER = "text.frag";

TextHandler::TextHandler(const char* fontPath): shader(VERT_SHADER, FRAG_SHADER)
{
	loadFont(fontPath); 
...
int TextHandler::loadFont(const char* fontPath)
{
	FT_Library ft;

...
void Turret::draw(bool isInterior)
{
    ...
    if (!target.isEmpty()) {
        if (timer.isFinished()) {
            textHandler.renderText(lines[2], 680.0f, 830.0f, 1.0f, glm::vec3(1.0f, 0.2f, 0.2f));
        }
        else {
        ...
        textHandler.renderText(lines[1], 610.0f, 830.0f, 1.0f, glm::vec3(0.2f, 1.0f, 0.2f));
    }

    textHandler.renderText(lines[0], 50.0f, 830.0f, 0.5f, glm::vec3(0.2f, 1.0f, 0.2f));
}
